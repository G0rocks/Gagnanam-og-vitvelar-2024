...
class IrisDataSet(Dataset):
    def __init__(self):
        ...
        # self.targets = torch.from_numpy(targets) # Original line from teachers
        self.targets = torch.from_numpy(targets).long() # Updated line from Harpa, see canvas discussions
